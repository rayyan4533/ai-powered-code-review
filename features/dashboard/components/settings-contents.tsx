            ...
            <CardContent className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-xs">Member since {memberSince}</p>
                    </div>
                </div>
                <Separator />
    ...
    return (
        <Card className={cardBorderClass}>
            ...
            <CardContent className="space-y-4">
                <div
                    className={cn(
                        "flex flex-wrap justify-between items-center gap-4 p-4 border rounded-none",
                        isActive
                ...
                <p className="text-muted-foreground text-xs">{getUsageText(usage)}</p>
