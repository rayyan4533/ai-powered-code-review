...
export function RepoList() {
    ...
    return (
        <div className="flex flex-col flex-1 gap-4 p-6">
            ...
            <div ref={loadMoreRef} className="py-2 text-muted-foreground text-sm text-center">
                {footer}
            </div>
        </div>
    );
        ...
        <TableRow>
            <TableCell>
                <div className="flex flex-col">
                    ...
                    <span className="text-muted-foreground text-xs">{repo.fullName}</span>
                </div>
            </TableCell>
            <TableCell>
            ...
            <TableCell className="text-right">
                <span className="inline-flex justify-end items-center gap-1 text-muted-foreground">
